...
const copy={
 pl:{title:'Kilka słów o plikach cookie',body:'Niezbędna pamięć pozwala Ci tworzyć list. Za Twoją zgodą opcjonalne pliki cookie pomagają nam zrozumieć, jak używane są nasze publiczne strony. Możesz odmówić i nadal korzystać ze wszystkich funkcji.',accept:'Akceptuj',reject:'Odrzuć',settings:'Ustawienia plików cookie',privacy:'Polityka prywatności',close:'Zamknij'},
 en:{title:'A little note about cookies',body:'We use essential storage to keep your letter journey working. With your permission, optional cookies help us understand how our public pages are used. You can say no and still use everything.',accept:'Accept',reject:'Reject',settings:'Cookie settings',privacy:'Privacy policy',close:'Close'},
 de:{title:'Ein kleiner Hinweis zu Cookies',body:'Notwendiger Speicher sorgt dafür, dass du deinen Brief erstellen kannst. Mit deiner Erlaubnis helfen uns optionale Cookies zu verstehen, wie unsere öffentlichen Seiten genutzt werden. Du kannst ablehnen und trotzdem alles nutzen.',accept:'Akzeptieren',reject:'Ablehnen',settings:'Cookie-Einstellungen',privacy:'Datenschutzerklärung',close:'Schließen'},
 es:{title:'Una pequeña nota sobre las cookies',body:'Usamos almacenamiento esencial para que puedas crear tu carta. Con tu permiso, las cookies opcionales nos ayudan a entender cómo se usan nuestras páginas públicas. Puedes rechazarlo y seguir usando todo.',accept:'Aceptar',reject:'Rechazar',settings:'Ajustes de cookies',privacy:'Política de privacidad',close:'Cerrar'},
 fr:{title:'Un petit mot sur les cookies',body:'Nous utilisons un stockage essentiel pour vous permettre de créer votre lettre. Avec votre accord, des cookies facultatifs nous aident à comprendre comment nos pages publiques sont utilisées. Vous pouvez refuser et continuer à tout utiliser.',accept:'Accepter',reject:'Refuser',settings:'Paramètres des cookies',privacy:'Confidentialité',close:'Fermer'}
};
export default function CookieConsent(){
 ...
 function choose(value){try{saveConsent(localStorage,value)}catch{}setChoice(value);setOpen(false);if(value==='accepted')startAnalytics(id);else stopAnalytics(id);requestAnimationFrame(()=>trigger.current?.focus())}
